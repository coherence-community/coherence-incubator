...
/**
 * The {@link SubscriptionLostException} is thrown when attempts
...
public class SubscriptionLostException extends RuntimeException
{
     ...
     */
    public SubscriptionLostException(SubscriptionIdentifier subscriptionIdentifier,
                                     String                 message)
    {
        super(message);
     ...
     *
     * @return {@link SubscriptionIdentifier}
     */
