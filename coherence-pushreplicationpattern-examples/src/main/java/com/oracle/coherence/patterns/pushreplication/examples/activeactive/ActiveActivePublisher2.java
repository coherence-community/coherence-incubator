/*
 * File: ActiveActivePublisher2.java
 *
...
/**
 * The {@link ActiveActivePublisher2} acts as an application
 * issuing updates which compute a running sum.  Running sums
 * are being maintained on ten entries keyed as strings from "0"
 * to "9".
 * <p>
 * All updates are computed in the local cluster ("Site2") and are
 * propagated to another cluster ("Site1") which is has its own
 ...
 */
public class ActiveActivePublisher2
{
    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        /*
         * ActiveActiveRunningSum site2done = (ActiveActiveRunningSum) namedCache.get(doneKey);
         * System.out.println("...Site2Done sum   = [" + site2done.m_runningSum + "]");
         * System.out.println("...Site2Done count = [" + site2done.m_updateCount + "]");
         */
