...
package com.oracle.coherence.common.namespace.fliter;
 ...
 * @author Brian Oliver
 */
public class FilterNamespaceHandlerTest
{
    /**
     * Establishes a {@link ProcessingContext} for the {@link FilterNamespaceHandler}
     *
     * @return A {@link ProcessingContext}
     *
     * @throws ConfigurationException if the {@link ProcessingContext} can't be established
     */
    ...
    public void testWhereFilter() throws ConfigurationException
    {
        ...
        Mockito.when(entry.getKey()).thenReturn("Angry koala because he's not a bear");
