...
/**
 * Integration tests for the {@link NonBlockingFiniteStateMachine}
 * <p>
...
public class TestNonBlockingFiniteStateMachine
{
    ...
    public void testSimpleLightSwitchMachine()
    {
        ...
        model.addStateEntryAction(Light.ON,
                                  new StateEntryAction<Light>()
                                  {
                                      @Override
        ...
        model.addStateEntryAction(Light.OFF,
                                  new StateEntryAction<Light>()
                                  {
                                      @Override
                                      public Instruction onEnterState(Light            previousState,
        ...
        model.addStateEntryAction(Light.BROKEN,
                                  new StateEntryAction<Light>()
                                  {
                                      @Override
                                      public Instruction onEnterState(Light            previousState,
    ...
    public void testSubsequentCoalescedEventProcessing()
    {
        ...
        machine.process(MotorEvent.TURN_ON);
        machine.processLater(new SubsequentEvent<Motor>(new CoalescedEvent<Motor>(event1,
                                                                                  Process.FIRST,
                                                                                  MotorEvent.TURN_OFF)),
                             10,
                             TimeUnit.SECONDS);
