...
/**
 * The {@link FilterNamespaceContentHandler} provides backwards compatibility
 * for the new {@link FilterNamespaceHandler}.
 *
 * @author Brian Oliver
 */
@Deprecated
public class FilterNamespaceContentHandler extends FilterNamespaceHandler
{
}
