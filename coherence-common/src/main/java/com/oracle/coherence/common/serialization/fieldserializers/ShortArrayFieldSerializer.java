/*
 * File: ShortArrayFieldSerializer.java
 *
...
/**
 * {@link ShortArrayFieldSerializer} is a {@link FieldSerializer} for {@link Short} arrays.
 * <p>
 ...
 */
public final class ShortArrayFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readShortArray(index));
    }
    ...
    {
        writer.writeShortArray(index, (short[]) field.get(object));
    }
}
