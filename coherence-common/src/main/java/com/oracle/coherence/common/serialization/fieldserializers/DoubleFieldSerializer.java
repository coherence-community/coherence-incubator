/*
 * File: DoubleFieldSerializer.java
 *
...
/**
 * A {@link DoubleFieldSerializer} is a {@link FieldSerializer} for {@link Double}s.
 * <p>
 ...
 */
public final class DoubleFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.setDouble(object, reader.readDouble(index));
    }
    ...
    {
        writer.writeDouble(index, field.getDouble(object));
    }
}
