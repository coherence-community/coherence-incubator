/*
 * File: FloatFieldSerializer.java
 *
...
/**
 * A {@link FloatFieldSerializer} is a {@link FieldSerializer} for {@link Float}s.
 * <p>
...
public final class FloatFieldSerializer implements FieldSerializer
{
    ...
    {
        field.setFloat(object, reader.readFloat(index));
    }
    ...
    {
        writer.writeFloat(index, field.getFloat(object));
    }
}
