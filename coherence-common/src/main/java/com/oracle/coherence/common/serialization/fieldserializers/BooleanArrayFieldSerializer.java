/*
 * File: BooleanArrayFieldSerializer.java
 *
...
/**
 * A {@link BooleanArrayFieldSerializer} is a {@link FieldSerializer} for {@link Boolean} arrays.
 * <p>
 ...
 */
public final class BooleanArrayFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readBooleanArray(index));
    }
    ...
    {
        writer.writeBooleanArray(index, (boolean[]) field.get(object));
    }
}
