/*
 * File: LongArrayFieldSerializer.java
 *
...
/**
 * A {@link LongArrayFieldSerializer} is a {@link FieldSerializer} for {@link Long} arrays.
 * <p>
 ...
 */
public final class LongArrayFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readLongArray(index));
    }
    ...
    {
        writer.writeLongArray(index, (long[]) field.get(object));
    }
}
