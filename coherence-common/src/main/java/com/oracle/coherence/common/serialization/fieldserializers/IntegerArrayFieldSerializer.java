/*
 * File: IntegerArrayFieldSerializer.java
 *
...
/**
 * An {@link IntegerArrayFieldSerializer} is a {@link FieldSerializer} for {@link Integer} arrays.
 * <p>
 ...
 */
public final class IntegerArrayFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readIntArray(index));
    }
    ...
    {
        writer.writeIntArray(index, (int[]) field.get(object));
    }
}
