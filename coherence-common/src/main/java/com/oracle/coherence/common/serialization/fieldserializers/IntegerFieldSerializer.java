/*
 * File: IntegerFieldSerializer.java
 *
...
/**
 * An {@link IntegerFieldSerializer} is a {@link FieldSerializer} for {@link Integer}s.
 * <p>
 ...
 */
public final class IntegerFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.setInt(object, reader.readInt(index));
    }
    ...
    {
        writer.writeInt(index, field.getInt(object));
    }
}
