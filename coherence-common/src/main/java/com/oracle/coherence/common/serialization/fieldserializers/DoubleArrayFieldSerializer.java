/*
 * File: DoubleArrayFieldSerializer.java
 *
...
/**
 * A {@link DoubleArrayFieldSerializer} is a {@link FieldSerializer} for {@link Double} arrays.
 * <p>
 ...
 */
public final class DoubleArrayFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readDoubleArray(index));
    }
    ...
    {
        writer.writeDoubleArray(index, (double[]) field.get(object));
    }
}
