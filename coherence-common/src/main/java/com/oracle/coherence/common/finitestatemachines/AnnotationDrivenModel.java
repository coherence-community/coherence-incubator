                ...
                for (com.oracle.coherence.common.finitestatemachines.annotations.Transition annTransition :
                    ...
                    if (stateTo == null)
                        ...
                        throw new IllegalArgumentException(String.format(
                            "The %s defined on %s declares a to state %s that is not defined by %s.", annTransition,
                            clzInstance, sStateToName, clzState));
                        }
            ...
            for (Method method : clzInstance.getMethods())
                ...
                if (annOnEnterState != null)
                    ...
                    if (state == null)
                        {
                        throw new IllegalArgumentException(String.format(
                            "The %s annotation on method %s defined in %s declares the state %s that is not defined in %s.",
                    ...
                    if (ReflectionHelper.isCompatibleMethod(method, Modifier.PUBLIC, Instruction.class, clzState,
                        ...
                        {
                        throw new IllegalArgumentException(String.format(
                            "The method %s defined in class %s annotated with %s is not compatible with the required method signature 'Instruction method(State, State, Context<State>);'.",
                ...
                if (annOnExitState != null)
                    ...
                    if (ReflectionHelper.isCompatibleMethod(method, Modifier.PUBLIC, Void.TYPE, clzState, Event.class,
                        ...
                        {
                        throw new IllegalArgumentException(String.format(
                            "The method %s defined in class %s annotated with %s is not compatible with the required method signature 'void method(State, Context<State>);'.",
                    ...
                    if (ReflectionHelper.isCompatibleMethod(method, Modifier.PUBLIC, Void.TYPE, String.class, clzState,
                        ...
                        for (String sStateFromName : annOnTransition.fromStates())
                            ...
                            if (stateFrom == null)
                                {
                                throw new IllegalArgumentException(String.format(
                                    "The %s defined on method %s in %s declares a from state %s that is not defined by %s.",
                                ...
                                for (String sStateToName : annOnTransition.toStates())
                                    ...
                                    if (stateTo == null)
                                        ...
                                        {
                                        throw new IllegalArgumentException(String.format(
                                            "The %s defined on method %s in %s specifies a transition from %s to %s that is not defined by the Finite State Machine.",
                        ...
                        {
                        throw new IllegalArgumentException(String.format(
                            "The method %s defined in class %s annotated with %s is not compatible with the required method signature 'void method(String, State, State, Event<State>, Context<State>);'.",
