/*
 * File: BigDecimalFieldSerializer.java
 *
...
/**
 * A {@link BigDecimalFieldSerializer} is a {@link FieldSerializer} for {@link BigDecimal}s.
 * <p>
 ...
 */
public final class BigDecimalFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readBigDecimal(index));
    }
    ...
    {
        writer.writeBigDecimal(index, (BigDecimal) field.get(object));
    }
}
