/*
 * File: BooleanFieldSerializer.java
 *
...
/**
 * A {@link BooleanFieldSerializer} is a {@link FieldSerializer} for {@link Boolean}s.
 * <p>
 ...
 */
public final class BooleanFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.setBoolean(object, reader.readBoolean(index));
    }
    ...
    {
        writer.writeBoolean(index, field.getBoolean(object));
    }
}
