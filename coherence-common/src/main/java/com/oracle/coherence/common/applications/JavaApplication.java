...
{
    /**
     * Returns the system {@link Properties} that were supplied to the {@link JavaApplication} when it was realized.
     *
    ...
    /**
     * Returns an {@link MBeanServerConnection} that may be used to access JMX infrastructure in the
    ...
    /**
     * Returns a local proxy of an MBean registered with the JMX infrastructure in the {@link JavaApplication}.
     * <p>
    ...
    /**
     * Returns the {@link MBeanInfo} of the specified MBean using the JMX infrastructure in the {@link JavaApplication}.
     * <p>
