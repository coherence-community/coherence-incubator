/*
 * File: FloatArrayFieldSerializer.java
 *
...
/**
 * A {@link FloatArrayFieldSerializer} is a {@link FieldSerializer} for {@link Float} arrays.
 * <p>
 ...
 */
public final class FloatArrayFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readFloatArray(index));
    }
    ...
    {
        writer.writeFloatArray(index, (float[]) field.get(object));
    }
}
