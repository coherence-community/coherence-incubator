/*
 * File: ShortFieldSerializer.java
 *
...
/**
 * A {@link ShortFieldSerializer} is a {@link FieldSerializer} for {@link Short}s.
 * <p>
 ...
 */
public final class ShortFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.setShort(object, reader.readShort(index));
    }
    ...
    {
        writer.writeShort(index, field.getShort(object));
    }
}
