...
/**
 * A {@link ByteFieldSerializer} is a {@link FieldSerializer} for {@link Byte}s.
 * <p>
 ...
 */
public final class ByteFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.setByte(object, reader.readByte(index));
    }
    ...
    {
        writer.writeByte(index, field.getByte(object));
    }
}
