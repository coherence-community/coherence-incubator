/*
 * File: StringFieldSerializer.java
 *
...
/**
 * A {@link StringFieldSerializer} is a {@link FieldSerializer} for {@link String}s.
 * <p>
 ...
 */
public final class StringFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readString(index));
    }
    ...
    {
        writer.writeString(index, (String) field.get(object));
    }
}
