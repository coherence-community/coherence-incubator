/*
 * File: RawQuadFieldSerializer.java
 *
...
/**
 * A {@link RawQuadFieldSerializer} is a {@link FieldSerializer} for {@link RawQuad}s.
 * <p>
 ...
 */
public final class RawQuadFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readRawQuad(index));
    }
    ...
    {
        writer.writeRawQuad(index, (RawQuad) field.get(object));
    }
}
