...
/**
 * A {@link DateFieldSerializer} is a {@link FieldSerializer} for {@link Date}s.
 * <p>
 ...
 */
public final class DateFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readDate(index));
    }
    ...
    {
        writer.writeDate(index, (Date) field.get(object));
    }
}
