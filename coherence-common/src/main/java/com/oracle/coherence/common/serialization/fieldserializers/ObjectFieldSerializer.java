/*
 * File: ObjectFieldSerializer.java
 *
...
/**
 * An {@link ObjectFieldSerializer} is a {@link FieldSerializer} for {@link Object}s.
 * <p>
 ...
 */
public final class ObjectFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readObject(index));
    }
    ...
    {
        writer.writeObject(index, field.get(object));
    }
}
