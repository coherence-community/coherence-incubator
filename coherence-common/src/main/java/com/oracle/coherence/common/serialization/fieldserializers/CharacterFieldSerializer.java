/*
 * File: CharacterFieldSerializer.java
 *
...
/**
 * A {@link CharacterFieldSerializer} is a {@link FieldSerializer} for {@link Character}s.
 * <p>
 ...
 */
public final class CharacterFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.setChar(object, reader.readChar(index));
    }
    ...
    {
        writer.writeChar(index, field.getChar(object));
    }
}
