...
/**
 * A {@link LeaseListener} specifies call-back methods
...
{
    /**
     * This method will be called when the specified {@link Lease} owned by the
     * specified lease owner has expired.
     *
    ...
    /**
     * This method will be called when the specified {@link Lease} owned by the
     * specified lease owner has been canceled.
     *
     * @param leaseOwner the owner of the lease
     * @param lease      the {@link Lease}
     */
    ...
    /**
     * This method will be called when the specified {@link Lease} owned by the
     * specified lease owner has been suspended.
     *
     * @param leaseOwner the owner of the lease
     * @param lease      the {@link Lease}
     */
