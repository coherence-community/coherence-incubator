/*
 * File: ByteArrayFieldSerializer.java
 *
...
/**
 * A {@link ByteArrayFieldSerializer} is a {@link FieldSerializer} for {@link Byte} arrays.
 * <p>
 ...
 */
public final class ByteArrayFieldSerializer implements FieldSerializer
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        field.set(object, reader.readByteArray(index));
    }
    ...
    {
        writer.writeByteArray(index, (byte[]) field.get(object));
    }
}
