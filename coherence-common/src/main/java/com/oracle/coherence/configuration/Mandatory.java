...
/**
 * The {@link Mandatory} annotation is used to declare that a property, typically signified by a
 * Java Bean setter method, <strong>must</strong> have it's value injected from by a {@link Configurator}.
 * If it does not an exception will be raised during configuration.
 * <p>
