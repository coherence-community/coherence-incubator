/*
 * File: StateExitTrackingAction.java
 *
...
/**
 * A Tracking Action for {@link StateExitAction}s.
 * <p>
 ...
 * @author Brian Oliver
 */
public class StateExitTrackingAction<S extends Enum<S>> implements StateExitAction<S>
{
    /**
    ...
    /**
     * Constructs a {@link StateExitTrackingAction}.
     */
    public StateExitTrackingAction()
    {
    ...
    public void onExitState(S                                                        state,
                            com.oracle.coherence.common.finitestatemachines.Event<S> event,
