                                                                                         ...
                                                                                         PortableObject
{
    ...
    public Object process(Entry entry)
    {
        ...
        {
            commandExecutor = CommandExecutorManager.ensure().ensureCommandExecutor(contextIdentifier,
                                                                                    (PartitionedService) binEntry.getContext()
                                                                                    .getCacheService());

            // accept the command execution request for execution
            return commandExecutor.acceptCommandExecutionRequest(commandExecutionRequest, binEntry.getContext());
        }
        else
        {
