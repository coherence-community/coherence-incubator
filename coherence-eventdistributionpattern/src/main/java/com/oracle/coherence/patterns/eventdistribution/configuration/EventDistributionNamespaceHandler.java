...
public class EventDistributionNamespaceHandler extends AbstractNamespaceHandler
{
     ...
     */
    private Map<ResourceRegistry, Set<String>> mapIntroduce = new HashMap<ResourceRegistry, Set<String>>();
    ...
    public EventDistributionNamespaceHandler()
    {
        ...
        {
            @Override
            public EventDistributorTemplate process(ProcessingContext context,
                                                    XmlElement        xmlElement) throws ConfigurationException
            {
                ...
                {
                    registry.registerResource(EventDistributorTemplate.class, template);
                }
                ...
                if (xmlElement.getParent() != null && xmlElement.getParent().getName().equals("cache-mapping"))
                {
                    ...
                    cacheMapping.getResourceRegistry().registerResource(EventDistributorTemplate.class, template);
                }
        ...
        {
            @Override
            public CoherenceEventDistributorBuilder process(ProcessingContext context,
                                                            XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        {
            @Override
            public JMSEventDistributorBuilder process(ProcessingContext context,
                                                      XmlElement        xmlElement) throws ConfigurationException
            {
                try
                {
        ...
        {
            @Override
            public ParameterizedBuilder<ConnectionFactory> process(ProcessingContext context,
                                                                   XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        registerProcessor("distribution-channels",
                          new ElementProcessor<List<EventChannelControllerDependenciesTemplate>>()
        {
            @Override
            public List<EventChannelControllerDependenciesTemplate> process(ProcessingContext context,
                                                                            XmlElement        xmlElement)
                                                                                throws ConfigurationException
            {
                List<EventChannelControllerDependenciesTemplate> listTemplates =
                    new ArrayList<EventChannelControllerDependenciesTemplate>();
                ...
                for (XmlElement elementChild : ((List<XmlElement>) xmlElement.getElementList()))
                {
                    ...
                    else
                    {
                        throw new ConfigurationException(String.format("Invalid participant definition [%s] in [%s]",
                                                         ...
                                                         "Please ensure the participant is correctly defined");
                    }
                }
        ...
        {
            @Override
            public EventChannelControllerDependenciesTemplate process(ProcessingContext context,
                                                                      XmlElement        xmlElement)
                                                                          throws ConfigurationException
            {
        ...
        {
            @Override
            public ParameterizedBuilder<EventChannel> process(ProcessingContext context,
                                                              XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        {
            @Override
            public EventChannelBuilder process(ProcessingContext context,
                                               XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        registerProcessor("remote-channel-scheme", new ElementProcessor<EventChannelBuilder>()
        {
            ...
            public EventChannelBuilder process(ProcessingContext context,
                                               XmlElement        xmlElement) throws ConfigurationException
            {
                return (EventChannelBuilder) context.processOnlyElementOf(xmlElement);
            }
        });
        ...
        {
            @Override
            public ParameterizedBuilder<ConflictResolver> process(ProcessingContext context,
                                                                  XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        {
            @Override
            public ParameterizedBuilder<EventIteratorTransformer> process(ProcessingContext context,
                                                                          XmlElement        xmlElement)
                                                                              throws ConfigurationException
            {
        ...
        {
            @Override
            public ParameterizedBuilder<EventTransformer> process(ProcessingContext context,
                                                                  XmlElement        xmlElement) throws ConfigurationException
            {
                return context.processOnlyElementOf(xmlElement);
            }
        ...
        {
            @Override
            public ChainedEventIteratorTransformerBuilder process(ProcessingContext context,
                                                                  XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        {
            @Override
            public EventEntryFilter process(ProcessingContext context,
                                            XmlElement        xmlElement) throws ConfigurationException
            {
                Object result = context.processOnlyElementOf(xmlElement);
        ...
        {
            @Override
            public EventOriginalEntryFilter process(ProcessingContext context,
                                                    XmlElement        xmlElement) throws ConfigurationException
            {
                Object result = context.processOnlyElementOf(xmlElement);
        ...
        {
            @Override
            public EventTypeFilter process(ProcessingContext context,
                                           XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        registerProcessor("filtering-transformer-scheme",
                          new ElementProcessor<FilteringEventIteratorTransformerBuilder>()
        {
            @Override
            public FilteringEventIteratorTransformerBuilder process(ProcessingContext context,
                                                                    XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        {
            @Override
            public MutatingEventIteratorTransformerBuilder process(ProcessingContext context,
                                                                   XmlElement        xmlElement) throws ConfigurationException
            {
        ...
        registerProcessor("coalescing-transformer-scheme",
                          new ElementProcessor<CoalescingEventIteratorTransformerBuilder>()
        {
            @Override
            public CoalescingEventIteratorTransformerBuilder process(ProcessingContext context,
                                                                     XmlElement        xmlElement)
                                                                         throws ConfigurationException
            {
                                 ...
                                 URI               uri)
    {
        ...
        // register a EventChannelControllerManager with the environment             c
        registry.registerResource(EventChannelControllerManager.class, new EventChannelControllerManager());
     ...
     */
    private void introduceOnce(ProcessingContext context,
                               String            configURI)
    {
        ResourceRegistry registry  = context.getResourceRegistry();
        ...
        if (!setConfig.contains(configURI))
        {
            ...
            // unregister the legacy-cache-config we just introduced
            // as it's not the main resource
