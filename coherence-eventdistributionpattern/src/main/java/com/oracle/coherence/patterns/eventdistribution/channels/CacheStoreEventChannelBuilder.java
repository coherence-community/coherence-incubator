/*
 * File: CacheStoreEventChannelBuilder.java
 *
...
/**
 * A {@link CacheStoreEventChannelBuilder} is an {@link EventChannelBuilder} for {@link CacheStoreEventChannel}s.
 * <p>
...
public class CacheStoreEventChannelBuilder extends AbstractEventChannelBuilder
{
     ...
     */
    private ParameterizedBuilder<CacheStore> builder;


    /**
     * Standard Constructor.
     */
    public CacheStoreEventChannelBuilder()
    {
    ...
    {
        return new CacheStoreEventChannel(contextCacheName.evaluate(parameterResolver),
                                          builder.realize(parameterResolver, classLoader, parameters));
    }
     ...
     */
    @Injectable
    public void setContextCacheName(Expression<String> contextCacheName)
    {
    ...
    public void setCacheStoreBuilder(ParameterizedBuilder<CacheStore> builder)
    {
    ...
    public void readExternal(DataInput in) throws IOException
    {
        ...
        this.builder = (ParameterizedBuilder<CacheStore>) ExternalizableHelper.readObject(in);
    }
    ...
    public void readExternal(PofReader reader) throws IOException
    {
        ...
        this.builder = (ParameterizedBuilder<CacheStore>) reader.readObject(101);
    }
