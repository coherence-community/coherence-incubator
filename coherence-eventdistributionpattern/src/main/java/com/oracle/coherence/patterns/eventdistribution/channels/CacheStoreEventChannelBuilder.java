...
public class CacheStoreEventChannelBuilder extends AbstractEventChannelBuilder
{
    ...
    {
        return new CacheStoreEventChannel(exprContextCacheName.evaluate(parameterProvider).getString(),
    ...
    public void readExternal(PofReader reader) throws IOException
    {
        ...
        this.builder = (ParameterizedBuilder<CacheStore>) reader.readObject(100);
    }
