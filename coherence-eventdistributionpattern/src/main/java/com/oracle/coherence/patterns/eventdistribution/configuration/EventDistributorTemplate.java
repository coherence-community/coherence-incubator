...
public class EventDistributorTemplate implements ParameterizedBuilder<EventDistributor>
{
                                    ...
                                    ParameterList     parameterList)
    {
        ...
        scopedResolver.add(new Parameter("distributor-name", distributor.getIdentifier().getSymbolicName()));
        scopedResolver.add(new Parameter("distributor-external-name", distributor.getIdentifier().getExternalName()));
