...
public class DistributableEntry implements Entry, BinaryEntry, ExternalizableLite, PortableObject
{
    ...
    /**
     * Obtains the {@link ClusterMetaInfo} of the cluster in which the
     * original value was created.
     *
     * @return the {@link ClusterMetaInfo} or null if not available
     */
    ...
    /**
     * Obtains the {@link ClusterMetaInfo} of the cluster in which the
     * {@link DistributableEntry} was created.
     *
     * @return the {@link ClusterMetaInfo} or null if not available
     */
