...
public abstract class AbstractPushReplicationTest extends AbstractCoherenceTest
{
    ...
    /**
     * Ensure that keys and values of replicated entries are not deserialized
     * during replication.
     *
     * @throws Exception
     */
    @SuppressWarnings("unchecked")
    @Test
    public final void testShouldNotDeserializeReplicatedKeysAndValues() throws Exception
    {
        final String                                               cacheName     = "publishing-cache";
        ...
        try
        {
            ...
            // populate the new york site
            randomlyPopulateNamedCacheWithDomainValues(CacheFactory.getCache(cacheName), 0, 500, "NEWYORK", false);
            ...
            // update the london site
            randomlyPopulateNamedCacheWithDomainValues(CacheFactory.getCache(cacheName), 1000, 500, "LONDON", false);
